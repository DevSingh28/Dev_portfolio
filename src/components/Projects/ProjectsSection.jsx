...
export default function ProjectsSection() {
  ...
  const handlePrivateRepo = (project) => {
    if (["SonicPlay", "Flowrone Interior"].includes(project.title)) {
      toast(
        "This repository is private. Please contact me to request access.",
        {
          icon: "🔒",
          duration: 4000,
          style: {
                  ...
                  <div className="space-y-4 z-10">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 ml-auto">
                        {project.github && (
                          <motion.button
                            onClick={() => handlePrivateRepo(project)}
